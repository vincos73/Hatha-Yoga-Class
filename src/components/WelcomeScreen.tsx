          ...
          <>
            ...
            <div className="bg-white/40 backdrop-blur-md p-6 rounded-2xl border border-white/60 shadow-xl space-y-4">
              ...
              <p className="text-[11px] text-[#2d3e35]/65 leading-relaxed">
                * La durata della sessione seleziona in automatico un set bilanciato di asana (9 passi per 15 min, 16 passi per 30 min, tutti i 30 passi per 45 min) e ne adatta il ritmo di tenuta complessivo.
              </p>
            </div>
            {/* Primary CTA Block */}
